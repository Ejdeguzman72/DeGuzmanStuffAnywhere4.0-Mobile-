    ...
    return (
        <View style={styles.view}>
                ...
                <ScrollView>
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            <Text style={styles.modalText}>Baked Stuffed Clams</Text>
                            <Text style={styles.modalText}>Ingredients</Text>
                            <Text>2 tablespoons olive oil</Text>
                            <Text>1 small red onion, coarsely chopped</Text>
                            <Text>5 garlic cloves, crushed</Text>
                            <Text>1 cup dry white wine</Text>
            ...
            <TouchableOpacity
                ...
                onPress={() => setModalVisible(!modalVisible)}
            >
                <Text style={styles.buttonText}>Baked Stuffed Clams</Text>
            </TouchableOpacity>
        </View>
    );
};
...
export default StuffedClamsRecipeModal;