...
const SalisburySteaksRecipeModal = () => {
    ...
    return (
        <View style={styles.view}>
                ...
                <ScrollView>
                    <View style={styles.centeredView}>
                        <View style={styles.modalView}>
                            <Text style={styles.modalText}>Salisbury Steaks</Text>
            ...
            <TouchableOpacity
                ...
                onPress={() => setModalVisible(!modalVisible)}
            >
                <Text style={styles.buttonText}>Salisbury Steaks</Text>
            </TouchableOpacity>
        </View>
    );
};
...
export default SalisburySteaksRecipeModal;